        ...
        {contents.map((value, index) => {
          return (
            <div key={index} className="flex relative items-center py-6 gap-10">
              ...
              <div className="flex-shrink-0 w-10 h-10 rounded-full mt-10 sm:mt-0 inline-flex items-center justify-center bg-[#00bfa6] text-white relative font-medium text-lg cursor-default">
                {index + 1}
              </div>
