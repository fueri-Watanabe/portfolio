        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-10 lg:gap-10 lg:h-auto">
          {Object.values(strengths).map((value, index) => {
            return (
              <div
                key={index}
                className="h-44 p-6 flex flex-col justify-between basis-1/3 dark:border rounded-xl hover:dark:bg-slate-400 hover:shadow-xl hover:dark:text-slate-900 transition select-none"
              >
