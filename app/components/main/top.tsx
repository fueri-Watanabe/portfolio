...
const Top = () => {
  return (
    <div className="container flex flex-col justify-center pt-16 h-full">
      ...
      <div className="flex flex-col md:flex-row justify-end md:justify-between items-center w-full px-8 lg:px-0">
        ...
        <div className="md:flex justify-center items-center hidden">
          <video
            ...
            playsInline
            poster="/working.webp"
            className="md:w-[400px] md:h-[400px] lg:w-[520px] lg:h-[520px]"
          >
