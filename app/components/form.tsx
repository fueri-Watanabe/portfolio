        ...
        <div className="mb-2">
          <div className="py-4">
            <div className="my-6">
              ...
              <input className="w-full dark:bg-gray-700 rounded text-base outline-none py-1 px-3 leading-6" />
            </div>
            <div className="my-6">
            ...
            <div className="my-6">
              ...
              <textarea className="w-full dark:bg-gray-700 rounded h-32 text-base outline-none py-1 px-3 leading-6" />
            </div>
          </div>
